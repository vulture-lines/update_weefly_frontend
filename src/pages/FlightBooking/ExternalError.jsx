...
export default function PaymentExternalErrorPro() {
  return (
          ...
          <div className="px-8 py-6">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                ...
                external server error. This is a technical issue with an
                external service and does not reflect any problem with your
                payment method.
              </p>
