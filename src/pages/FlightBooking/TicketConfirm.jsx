          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <p>
                ...
                {paymentDetails?.Paymentresponse?.merchantRespMerchantRef || id}
              </p>
              <p>
                <span className="font-medium">Transaction Date:</span>{" "}
                {getCurrentDate()}
      ...
      >
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-8 mb-6">
            ...
            <div>
              <p className="text-sm">
                <span className="font-medium">PNR No:</span> {id}
              </p>
            </div>
          </div>
          ...
          <div>
            <h4 className="text-md font-bold mb-4">Travellers Information</h4>
            <div className="space-y-3">
              {BookingTravellerData?.map((traveller, index) => (
                <div
                  key={index}
                  className="flex justify-between items-center text-sm p-3 border rounded"
                  style={{ borderColor: "#d4d4d4", backgroundColor: "#f9f9f9" }}
                >
                  <div>
                    <span className="font-medium">Traveller {index + 1}:</span>{" "}
                    {traveller.Name[0].Title}.{" "}
                    {traveller.Name[0].NamePartList[0].NamePart.join(" ")}
                  </div>
                  <div>
                    <span className="font-medium">Seat:</span>{" "}
                    {
                      traveller.CustomSupplierParameterList[0]
                        .CustomSupplierParameter[1].Value
                    }
                  </div>
                </div>
