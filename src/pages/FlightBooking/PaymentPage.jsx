  ...
  */
  ...
  const handleBooking = async (e) => {
    ...
    const Receipt = {
      ...
      luggageCharge: `${location.state?.luggageSurcharge} CVE`,
      Totaltax: `${tax}`,
                  ...
                  <div className="flex flex-col md:flex-row space-y-6 py-6 justify-between items-center px-4 pt-4">
                    <div className="flex flex-col min-w-[170px] relative">
                      <img
                        ...
                        alt={OutwardTicket.segments[0].airline}
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <span className="text-[12px] text-gray-400 mt-[4px]">
                          {(OutwardTicket?.segments?.[1]?.departureDate ?? OutwardTicket?.segments?.[0]?.departureDate)?.split("-")[0]}
                        </span>
                      </div>
                      <div className="text-center">
                        <p className="text-[22px] font-bold text-black">
                          {OutwardTicket?.segments[1] ? OutwardTicket?.segments[1].arrivalTime : OutwardTicket?.segments[0].arrivalTime}
                        </p>
                        <p className="text-[13px] text-gray-500">
                          {OutwardTicket?.segments[1] ? OutwardTicket.segments[1].arrivalCity : OutwardTicket?.segments[0].arrivalCity}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col md:flex-row space-y-6 py-6 justify-between items-center px-4 pt-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <span className="text-[12px] text-gray-400 mt-[4px]">
                          {parseInt(OutwardTicket.segments[0].duration) + parseInt(OutwardTicket?.segments[1]?.duration || 0) + 'hr'}
                        </span>
                      </div>
                      <div className="text-center">
                        <p className="text-[22px] font-bold text-black">
                  ...
                  <div className="flex flex-col md:flex-row space-y-6 py-6 justify-between items-center px-4 pt-4">
                    <div className="flex flex-col min-w-[170px] relative">
                      <img
                        ...
                        alt={returnTicket.segments[0].airline}
                        className="w-[120px] h-[40px] object-contain mb-[25px]"
                      />
                      <div className="absolute top-[38px] left-[4px] flex items-center space-x-2">
                        {/* <span className="text-[13px] text-gray-500">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <span className="text-[12px] text-gray-400 mt-[4px]">
                          {parseInt(returnTicket.segments[0].duration) + parseInt(returnTicket?.segments[1]?.duration || 0) + 'hr'}
                        </span>
                      </div>
                      <div className="text-center">
                        <p className="text-[22px] font-bold text-black">
                          {returnTicket.segments[1] ? returnTicket?.segments[1].arrivalTime : returnTicket?.segments[0].arrivalTime}
                        </p>
                        <p className="text-[13px] text-gray-500">
                          {returnTicket.segments[1] ? returnTicket.segments[1].arrivalCity : returnTicket.segments[0].arrivalCity}
                        </p>
                      </div>
                    </div>
                    <div className="text-right flex flex-col items-center lg:items-end space-y-[2px] w-[152px]">
                ...
                <div className="flex justify-between px-6 mt-6">
                  ...
                  <div className="text-left w-1/2 pl-4">
                    ...
                    <p className="text-xs text-gray-500 mt-[2px] ml-5">
                      {(OutwardTicket?.segments?.[1]?.arrivalDate ?? OutwardTicket?.segments?.[0]?.arrivalDate)?.split("-")[0]}
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex justify-between px-6 mt-6">
                    <div className="text-left w-1/2 border-r pr-4">
                      ...
                      <p className="text-xs text-gray-500 mt-[2px]">
                        ...
                        {(returnTicket?.segments?.[1]?.departureDate ?? returnTicket?.segments?.[0]?.departureDate)?.split("-")[0]}
                      </p>
                    </div>
                    <div className="text-left w-1/2 pl-4">
                      <p className="text-sm font-semibold text-black font-jakarta ml-5">
                      ...
                      <p className="text-xs text-gray-500 mt-[2px] ml-5">
                        ...
                        {(returnTicket?.segments?.[1]?.arrivalDate ?? returnTicket?.segments?.[0]?.arrivalDate)?.split("-")[0]}
                      </p>
                    </div>
                  </div>
                </div>
