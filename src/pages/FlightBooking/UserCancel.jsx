...
export default function PaymentUserCancelPro() {
  return (
          ...
          <div className="px-8 py-6">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Your flight booking payment was cancelled by your request. The
                payment process was interrupted before completion and no
              ...
              <div className="flex items-start gap-3 p-4 bg-gray-50 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    ...
                    was compromised during this cancellation.
                  </p>
                </div>
              </div>
            </div>
