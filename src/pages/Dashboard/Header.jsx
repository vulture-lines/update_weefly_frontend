      ...
      <div className="flex justify-between items-start w-full relative">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-12">
            <p className="text-[15px] font-medium">
              <span className="text-[#f9632c] font-semibold">Welcome,</span> john brevis
            </p>
        ...
        <div className="flex flex-col items-end gap-2">
          <div className="flex items-center gap-4">
            <img src={NotificationIcon} alt="Notification" className="w-[32px] h-[32px]" />
            ...
            <div className="flex items-center gap-2 border px-3 py-[6px] rounded-md shadow-sm bg-white min-w-[160px]">
              ...
              <div className="text-sm leading-tight ">
                ...
                <p className="text-gray-400 text-xs leading-none mt-[2px]">Admin</p>
              </div>
            </div>
          </div>
